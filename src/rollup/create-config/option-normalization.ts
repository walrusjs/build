 ...
 */
export function toReplacementExpression(value: string, name: string): [string, string] {
 ...
 */
export function parseMappingArgument(globalStrings, processValue?: (value: string, key: string) => [string, string]) {
	const globals = {};
 ...
 * Parses values of the form "$=jQuery,React=react" into key-value object pairs.
 */
export function parseAliasArgument(
	aliasStrings: string
): Alias[] {
