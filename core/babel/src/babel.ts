...
type FILE_TYPE_TYPE = 'NON_COMPILABLE' | 'COMPILED' | 'IGNORED' | 'ERR_COMPILATION';

const FILE_TYPE: Record<FILE_TYPE_TYPE, FILE_TYPE_TYPE> = Object.freeze({
